...
//    }
//
////    private <T> ResponseEntity exec(Supplier<ResponseEntity> supplier, Class<T> response) {
////        try {
////            return supplier.get();
...
////    }
////
////    public <T> ResponseEntity getForObject(String url, HttpEntity<T> requestEntity, Class<T> responseClass) {
////        logger.info("url: {}", url);
